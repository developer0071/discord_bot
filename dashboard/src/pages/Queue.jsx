...
export default function Queue() {
  const { queue, acceptFromQueue, rejectFromQueue, acceptAllQueue, rejectAllQueue } = useApp();
    ...
    <div className="tab-content active" id="tab-queue">
      <div className="page-title-row">
        <div>
          ...
          <div className="page-subtitle">Review and accept incoming join requests</div>
        </div>
